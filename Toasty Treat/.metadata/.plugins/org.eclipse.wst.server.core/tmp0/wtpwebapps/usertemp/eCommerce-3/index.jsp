...
<html lang="en">
   <head>
      ...
      <!-- Favicon Icon -->
      <link rel="icon" type="/png" href="userResources\images\favicon.png">
      <!-- Bootstrap core CSS -->
   ...
   <body>
      ...
      <section class="carousel-slider-main text-center border-top border-bottom bg-white">
         <div class="owl-carousel owl-carousel-slider">
            <div class="item">
               <a href="shop.html"><img class="img-fluid" src="userResources\images\slider1.jpg" alt="First slide"></a>
            </div>
            <div class="item">
               <a href="shop.html"><img class="img-fluid" src="userResources\images\slider2.jpg" alt="First slide"></a>
            </div>
         </div>
      </section>
            ...
            <div class="owl-carousel owl-carousel-category">
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s1.jpg" alt="">
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s2.jpg" alt="">
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s3.jpg" alt="">
                        <h6>Beverages</h6>
                        <p>65 Items</p>
                     </a>
                  </div>
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s4.jpg" alt="">
                        <h6>Home & Kitchen</h6>
                        <p>965 Items</p>
                     </a>
                  </div>
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s5.jpg" alt="">
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s6.jpg" alt="">
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s7.jpg" alt="">
                        <h6>Personal Care</h6>
                        <p>156 Items</p>
                     </a>
                  </div>
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s8.jpg" alt="">
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s9.jpg" alt="">
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s10.jpg" alt="">
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s11.jpg" alt="">
                        <h6>Pet Care</h6>
                        <p>568 Items</p>
                     </a>
                  </div>
               ...
               <div class="item">
                  <div class="category-item">
                     <a href="shop.html">
                        <img class="img-fluid" src="userResources\images\s12.jpg" alt="">
               ...
               <div class="item">
                  <div class="product">
                     <a href="single.html">
                        <div class="product-header">
                           <span class="badge badge-success">50% OFF</span>
                           <img class="img-fluid" src="userResources\images\3.jpg" alt="">
                           <span class="non-veg text-danger mdi mdi-circle"></span>
                        </div>
                        <div class="product-body">
                           <h5>Product Title Here</h5>
               ...
               <div class="item">
                  <div class="product">
                     <a href="single.html">
                        <div class="product-header">
                           <span class="badge badge-success">50% OFF</span>
                           <img class="img-fluid" src="userResources\images\4.jpg" alt="">
                           <span class="veg text-success mdi mdi-circle"></span>
                        </div>
                        <div class="product-body">
                           <h5>Product Title Here</h5>
               ...
               <div class="item">
                  <div class="product">
                     <a href="single.html">
                        <div class="product-header">
                           <span class="badge badge-success">50% OFF</span>
                           <img class="img-fluid" src="userResources\images\5.jpg" alt="">
                           <span class="veg text-success mdi mdi-circle"></span>
                        </div>
                        <div class="product-body">
                           <h5>Product Title Here</h5>
      ...
      <section class="offer-product">
         <div class="container">
            <div class="row no-gutters">
               <div class="col-md-6">
                  <a href="#"><img class="img-fluid" src="userResources\images\add1.jpg" alt=""></a>
               </div>
               <div class="col-md-6">
                  <a href="#"><img class="img-fluid" src="userResources\images\add2.jpg" alt=""></a>
               </div>
            </div>
         </div>
      </section>
               ...
               <div class="item">
                  <div class="product">
                     <a href="single.html">
                        <div class="product-header">
                           <span class="badge badge-success">50% OFF</span>
                           <img class="img-fluid" src="userResources\images\8.jpg" alt="">
                           <span class="non-veg text-danger mdi mdi-circle"></span>
                        </div>
                        <div class="product-body">
                           <h5>Product Title Here</h5>
               ...
               <div class="item">
                  <div class="product">
                     <a href="single.html">
                        <div class="product-header">
                           <span class="badge badge-success">50% OFF</span>
                           <img class="img-fluid" src="userResources\images\10.jpg" alt="">
                           <span class="veg text-success mdi mdi-circle"></span>
                        </div>
                        <div class="product-body">
                           <h5>Product Title Here</h5>
               ...
               <div class="item">
                  <div class="product">
                     <a href="single.html">
                        <div class="product-header">
                           <span class="badge badge-success">50% OFF</span>
                           <img class="img-fluid" src="userResources\images\12.jpg" alt="">
                           <span class="veg text-success mdi mdi-circle"></span>
                        </div>
                        <div class="product-body">
                           <h5>Product Title Here</h5>
