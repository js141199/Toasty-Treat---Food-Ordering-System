		...
		<div class="cart-sidebar-body">
			<div class="cart-list-product">
				<a class="float-right remove-cart" href="#"><i
					...
					src="<%=request.getContextPath()%>\userResources\images\11.jpg" alt=""> <span
			...
			<div class="cart-list-product">
				<a class="float-right remove-cart" href="#"><i
					class="mdi mdi-close"></i></a> <img class="img-fluid"
					src="<%=request.getContextPath()%>\userResources\images\7.jpg" alt=""> <span
					class="badge badge-success">50% OFF</span>
				<h5>
					<a href="#">Product Title Here</a>
				</h5>
			...
			<div class="cart-list-product">
				<a class="float-right remove-cart" href="#"><i
					class="mdi mdi-close"></i></a> <img class="img-fluid"
					src="<%=request.getContextPath()%>\userResources\images\9.jpg" alt=""> <span
					class="badge badge-success">50% OFF</span>
				<h5>
					<a href="#">Product Title Here</a>
				</h5>
			...
			<div class="cart-list-product">
				<a class="float-right remove-cart" href="#"><i
					class="mdi mdi-close"></i></a> <img class="img-fluid"
					src="<%=request.getContextPath()%>\userResources\images\1.jpg" alt=""> <span
					class="badge badge-success">50% OFF</span>
				<h5>
					<a href="#">Product Title Here</a>
				</h5>
			...
			<div class="cart-list-product">
				<a class="float-right remove-cart" href="#"><i
					class="mdi mdi-close"></i></a> <img class="img-fluid"
					src="<%=request.getContextPath()%>\userResources\images\2.jpg" alt=""> <span
					class="badge badge-success">50% OFF</span>
				<h5>
					<a href="#">Product Title Here</a>
				</h5>
