...
<meta
	...
	name="viewport">
<title>The Toasty Treat Product</title>
<!-- General CSS Files -->
												...
												<tbody>
													<c:forEach items="${subcategoryList}" var="i" varStatus="j">
														<tr>
															...
															<td>${i.price}</td>
															<td>${i.fileName}</td>
															 	<td><a href="<%=request.getContextPath()%>/document/product/${i.fileName}" target="_blank">view</a></td>
															<td><a href="editSubCategory?id=${i.id}" ><i class="fa fa-edit"></i></a>
																<a href="deleteSubCategory?id=${i.id}"><i class="fa fa-trash"></i> </a></td>
														</tr>
													</c:forEach>
